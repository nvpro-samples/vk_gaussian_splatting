...
![Stochastic Splat — global sorting and blending (ground truth) vs. stochastic transparency at 1, 5, and 16 SPP, with PSNR and FLIP convergence curves](../images/stochastic_splat_spp_comparison.png)
...
![Stochastic Pass — full pass ray tracing (ground truth) vs. stochastic transparency ray tracing at 1, 5, and 16 PPP, with PSNR and FLIP convergence curves](../images/stochastic_pass_ppp_comparison.png)
